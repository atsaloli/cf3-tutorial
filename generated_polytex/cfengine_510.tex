...
\section{CFEngine Special Variables}
...
You can see the whole list in the \href{https://docs.cfengine.com/docs/3.12/reference-special-variables.html}{Special Variables}
...
\begin{description}
\item[\textbf{edit.filename}] Points to the filename of the file currently making an edit promise.
\end{description}
...
Output on my system \kode{myhost.example.com}:
