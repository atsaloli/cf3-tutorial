...
\chapter{Appendix A - CFEngine Vocabulary Primer}
...
\href{http://cf-learn.info/}{search box} (on the bottom right),
or see the \href{https://cfengine.com/docs/}{CFEngine docs}

For professional CFEngine training, visit \href{http://www.verticalsysadmin.com}{Vertical Sysadmin}
...
\section{Promise Attributes}

What follows is a listing of promise attributes by promise type.

\subsection{Any}

These promise attributes can be used in \emph{any} promise.
...
\subsection{Attributes in CFEngine Standard Library}
