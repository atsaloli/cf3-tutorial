#!/bin/sh
# SKIP - do not include this script in the HTML output or in the class slideshow
#
# Run this shell script on your Hub VM to add the following to your .vimrc:
...
echo Downloading and installing vim editor plugin for CFEngine syntax highlighting
